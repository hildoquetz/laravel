                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            <a title="This question is userful" href="" class="vote-up">
                                <i class="fas fa-caret-up fa-3x"></i>
                            </a>
                            <span class="votes-count">1231</span>
                            <a title="This question is not userful" href="" class="vote-up">
                                <i class="fas fa-caret-down fa-3x"></i>
                            </a>
                            <span class="votes-count off">31</span>
                            <a href="" title="Click to mark as favorite" class="favorite mt-2">
